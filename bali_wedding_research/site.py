...
.preview-media-fallback {
  display: grid;
  background:
    radial-gradient(circle at 18% 18%, rgba(231, 196, 128, 0.32), transparent 30%),
    linear-gradient(145deg, #29443d 0%, #17342f 48%, #0f2926 100%);
}
...
.preview-media-content {
  ...
  padding: 22px;
  color: #fff8ed;
  text-shadow: 0 1px 2px rgba(10, 24, 22, 0.42);
}
...
.preview-media-link {
  ...
  text-decoration: none;
  text-shadow: none;
  box-shadow: 0 8px 18px rgba(5, 20, 18, 0.24);
